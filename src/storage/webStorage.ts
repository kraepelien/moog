...
import { type DraftStore, type PatchStore, type PatchSummary, StoreError } from './types.ts'
...
export function createWebStorageStore(storage: StorageLike): PatchStore & DraftStore {
  return {
